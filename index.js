...
// Анімація для заголовка та тексту
...
const doneFeetback = document.querySelector(".done__feetback");
const footerLogo = document.querySelector(".header__logo.footer");
...
gsap.to(".dream__btn", {
  ...
  ease: "power3.out",
  delay: 7 // Затримка перед початком анімації
});
gsap.from(".done", {
  scrollTrigger: {
    trigger: ".done",
